...
This is a sample template for default-vpc-removal-lambda - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name default-vpc-removal-lambda --tail
```
...
```bash
aws cloudformation delete-stack --stack-name default-vpc-removal-lambda
```
